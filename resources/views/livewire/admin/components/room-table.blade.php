<div>
    ...
    @if (session('SuccessMes'))
        <div id="toast-success"
            ...
            <div class="ms-3 text-sm font-normal">{{session('SuccessMes')}}</div>
        </div>
    @endif
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                <div class="col-span-2">
                                    ...
                                    <input
                                        ...
                                        type="text" wire:model="roomForm.name" placeholder="Tên phòng">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <input
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        type="text" wire:model="roomForm.room_number" placeholder="Số phòng">
                                </div>

                                <div class="col-span-1">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Kiểu phòng</label>
                                    <select wire:model="roomForm.room_type_id"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select wire:model="roomForm.status"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
